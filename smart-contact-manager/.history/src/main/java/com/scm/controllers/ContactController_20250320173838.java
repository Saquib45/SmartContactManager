...
public class ContactController {
    ...
    private final OAuthAuthenicationSuccessHandler OAuthAuthenticationSuccessHandler;
    @Autowired
    ...
    ContactController(OAuthAuthenicationSuccessHandler OAuthAuthenticationSuccessHandler) {
