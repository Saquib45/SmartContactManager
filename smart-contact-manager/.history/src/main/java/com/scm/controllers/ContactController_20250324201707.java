...
public class ContactController {
    ...
    //for delete contact from contact list
    ...
    public String updateContactFormView(@PathVariable("contactId") String contactIt,Model model){

        var contact=contactService.getById(contactIt);

        ContactForm contactForm=new ContactForm();
        contactForm.setName(contact.getName());
        contactForm.setEmail(contact.getEmail());
        contactForm.setPhoneNumber(contact.getPhonesetPhoneNumber());
        contactForm.setName(contact.getName());
        contactForm.setName(contact.getName());
        contactForm.setName(contact.getName());
        contactForm.setName(contact.getName());
