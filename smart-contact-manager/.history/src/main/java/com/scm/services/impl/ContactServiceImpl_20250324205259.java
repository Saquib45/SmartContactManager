...
public class ContactServiceImpl implements ContactService {
    ...
    public Contact update(Contact contact) {
        ...
        conta.setEmail(contact.getEmail());
        conta.setPhoneNumber(contact.getPhoneNumber());
        conta.setAddress(contact.getAddress());
        conta.setDescription(contact.getDescription());
        conta.setFavorite(contact.isFavorite());
        conta.setWebsiteLink(contact.getWebsiteLink());
        conta.setLinkedInLink(contact.getLinkedInLink());
        conta.setPicture(contact.getPicture());  
    }
